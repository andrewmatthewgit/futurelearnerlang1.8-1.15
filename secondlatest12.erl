-module(secondlatest12).
-export([double/1,product/1,mult/2,maxlist/1,areaold/3,square/1,freq/2,freq2/1,even/1,doublelist/1,treble/1,mode/1,hypot/2,encl/1,perimtriangle/2,maxThree/3,howManyEqual/3,bits/1,fib/1,pieces/1,area/1,perim/1]).
